...
>>> Data[4][a:6]
'Dandun'
>>> # elemen list Data indeks ke-4 yang berisi Nama kemudian program akan menjadi Nama[a:6] dimana a berisi data 0 maka akan menjadi Nama[0:6] yang akan meampilkan elemen list indeks ke-0 hingga sebelum indeks ke-6 yaitu Dandun
>>> Data[0] = 'ok'; Data
['ok', 60, 1.65, 172, 'Dandun Gigih Prakoso']
